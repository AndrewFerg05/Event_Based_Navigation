...
protected:
  Image(PixelOrder pixel_order = PixelOrder::undefined)
...
typedef Image<Pixel8uC1> Image8uC1;
typedef Image<Pixel8uC2> Image8uC2;
typedef Image<Pixel8uC3> Image8uC3;
typedef Image<Pixel8uC4> Image8uC4;

typedef Image<Pixel16uC1> Image16uC1;
typedef Image<Pixel16uC2> Image16uC2;
typedef Image<Pixel16uC3> Image16uC3;
typedef Image<Pixel16uC4> Image16uC4;

typedef Image<Pixel32sC1> Image32sC1;
typedef Image<Pixel32sC2> Image32sC2;
typedef Image<Pixel32sC3> Image32sC3;
typedef Image<Pixel32sC4> Image32sC4;

typedef Image<Pixel32fC1> Image32fC1;
typedef Image<Pixel32fC2> Image32fC2;
typedef Image<Pixel32fC3> Image32fC3;
typedef Image<Pixel32fC4> Image32fC4;
