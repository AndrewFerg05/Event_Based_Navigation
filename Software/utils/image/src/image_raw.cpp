...
ImageRaw<Pixel>::ImageRaw(const Size2u& size, PixelOrder pixel_order)
...
template class ImageRaw<Pixel8uC1>;
template class ImageRaw<Pixel8uC2>;
template class ImageRaw<Pixel8uC3>;
template class ImageRaw<Pixel8uC4>;

template class ImageRaw<Pixel16sC1>;
template class ImageRaw<Pixel16sC2>;
template class ImageRaw<Pixel16sC3>;
template class ImageRaw<Pixel16sC4>;

template class ImageRaw<Pixel16uC1>;
template class ImageRaw<Pixel16uC2>;
template class ImageRaw<Pixel16uC3>;
template class ImageRaw<Pixel16uC4>;

template class ImageRaw<Pixel32sC1>;
template class ImageRaw<Pixel32sC2>;
template class ImageRaw<Pixel32sC3>;
template class ImageRaw<Pixel32sC4>;

template class ImageRaw<Pixel32fC1>;
template class ImageRaw<Pixel32fC2>;
template class ImageRaw<Pixel32fC3>;
template class ImageRaw<Pixel32fC4>;
