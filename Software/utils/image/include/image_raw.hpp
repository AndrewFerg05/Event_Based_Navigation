...
class ImageRaw : public Image<Pixel>
{
public:
  ZE_POINTER_TYPEDEFS(ImageRaw);

  using Base = Image<Pixel>;
  using Memory = MemoryStorage<Pixel>;
  using Deallocator = MemoryDeallocator<Pixel>;
...
typedef ImageRaw<Pixel8uC1> ImageRaw8uC1;
typedef ImageRaw<Pixel8uC2> ImageRaw8uC2;
typedef ImageRaw<Pixel8uC3> ImageRaw8uC3;
typedef ImageRaw<Pixel8uC4> ImageRaw8uC4;

typedef ImageRaw<Pixel16sC1> ImageRaw16sC1;
typedef ImageRaw<Pixel16sC2> ImageRaw16sC2;
typedef ImageRaw<Pixel16sC3> ImageRaw16sC3;
typedef ImageRaw<Pixel16sC4> ImageRaw16sC4;

typedef ImageRaw<Pixel16uC1> ImageRaw16uC1;
typedef ImageRaw<Pixel16uC2> ImageRaw16uC2;
typedef ImageRaw<Pixel16uC3> ImageRaw16uC3;
typedef ImageRaw<Pixel16uC4> ImageRaw16uC4;

typedef ImageRaw<Pixel32sC1> ImageRaw32sC1;
typedef ImageRaw<Pixel32sC2> ImageRaw32sC2;
typedef ImageRaw<Pixel32sC3> ImageRaw32sC3;
typedef ImageRaw<Pixel32sC4> ImageRaw32sC4;

typedef ImageRaw<Pixel32fC1> ImageRaw32fC1;
typedef ImageRaw<Pixel32fC2> ImageRaw32fC2;
typedef ImageRaw<Pixel32fC3> ImageRaw32fC3;
typedef ImageRaw<Pixel32fC4> ImageRaw32fC4;
