...
class ImageCv : public Image<Pixel>
{
public:
...
public:
  ...
  ImageCv(const Size2u& size, PixelOrder pixel_order=PixelOrder::undefined);
  ImageCv(uint32_t width, uint32_t height, PixelOrder pixel_order=PixelOrder::undefined);
  ImageCv(const ImageCv<Pixel>& from);
  ImageCv(const Base& from);
  ImageCv(cv::Mat mat, PixelOrder pixel_order=PixelOrder::undefined);
...
typedef ImageCv<Pixel8uC1> ImageCv8uC1;
typedef ImageCv<Pixel8uC2> ImageCv8uC2;
typedef ImageCv<Pixel8uC3> ImageCv8uC3;
typedef ImageCv<Pixel8uC4> ImageCv8uC4;

typedef ImageCv<Pixel16uC1> ImageCv16uC1;
typedef ImageCv<Pixel16uC2> ImageCv16uC2;
typedef ImageCv<Pixel16uC3> ImageCv16uC3;
typedef ImageCv<Pixel16uC4> ImageCv16uC4;

typedef ImageCv<Pixel32sC1> ImageCv32sC1;
typedef ImageCv<Pixel32sC2> ImageCv32sC2;
typedef ImageCv<Pixel32sC3> ImageCv32sC3;
typedef ImageCv<Pixel32sC4> ImageCv32sC4;

typedef ImageCv<Pixel32fC1> ImageCv32fC1;
typedef ImageCv<Pixel32fC2> ImageCv32fC2;
typedef ImageCv<Pixel32fC3> ImageCv32fC3;
typedef ImageCv<Pixel32fC4> ImageCv32fC4;
