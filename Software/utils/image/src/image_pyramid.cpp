...
{
  this->init(size);
  //this->updateImage(img, InterpolationMode::Linear);
}
...
//------------------------------------------------------------------------------
template<typename Pixel>
void ImagePyramid<Pixel>::init(const Size2u& size)
{
...
template class ImagePyramid<Pixel8uC1>;
template class ImagePyramid<Pixel8uC2>;
//template class ImagePyramid<imp::Pixel8uC3>;
template class ImagePyramid<Pixel8uC4>;

template class ImagePyramid<Pixel16uC1>;
template class ImagePyramid<Pixel16uC2>;
//template class ImagePyramid<imp::Pixel16uC3>;
template class ImagePyramid<Pixel16uC4>;

template class ImagePyramid<Pixel32sC1>;
template class ImagePyramid<Pixel32sC2>;
//template class ImagePyramid<imp::Pixel32sC3>;
template class ImagePyramid<Pixel32sC4>;

template class ImagePyramid<Pixel32fC1>;
template class ImagePyramid<Pixel32fC2>;
//template class ImagePyramid<imp::Pixel32fC3>;
template class ImagePyramid<Pixel32fC4>;
