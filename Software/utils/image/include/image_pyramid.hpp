...
public:
  ...
  using Image = Image<Pixel>;
  using ImagePtr = ImagePtr<Pixel>;
...
typedef ImagePyramid<Pixel8uC1> ImagePyramid8uC1;
typedef ImagePyramid<Pixel8uC2> ImagePyramid8uC2;
typedef ImagePyramid<Pixel8uC3> ImagePyramid8uC3;
typedef ImagePyramid<Pixel8uC4> ImagePyramid8uC4;

typedef ImagePyramid<Pixel16uC1> ImagePyramid16uC1;
typedef ImagePyramid<Pixel16uC2> ImagePyramid16uC2;
typedef ImagePyramid<Pixel16uC3> ImagePyramid16uC3;
typedef ImagePyramid<Pixel16uC4> ImagePyramid16uC4;

typedef ImagePyramid<Pixel32sC1> ImagePyramid32sC1;
typedef ImagePyramid<Pixel32sC2> ImagePyramid32sC2;
typedef ImagePyramid<Pixel32sC3> ImagePyramid32sC3;
typedef ImagePyramid<Pixel32sC4> ImagePyramid32sC4;

typedef ImagePyramid<Pixel32fC1> ImagePyramid32fC1;
typedef ImagePyramid<Pixel32fC2> ImagePyramid32fC2;
typedef ImagePyramid<Pixel32fC3> ImagePyramid32fC3;
typedef ImagePyramid<Pixel32fC4> ImagePyramid32fC4;
